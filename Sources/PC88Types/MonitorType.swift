...
///
///   * the frame rate (`PC88.frameRate`) — 62.42Hz vs 55.42Hz for a 25-row
///     screen
///   * port 0x40 read bit 1 (SHG), which software may read directly
///   * GVRAM wait states in V1S/N mode
///
...
public enum MonitorType: Int, Sendable, CaseIterable {
  ...
  package var horizontalFrequency: Double {
    switch self {
  ...
  package var resetCharLinesPerRow: UInt8 {
    switch self {
    case .khz15: return 8
